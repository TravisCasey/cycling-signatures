...
candidate_times = candidate_rows * _support.LORENZ_DT
inside_labeled = (candidate_times >= PARAMETERS[extent_start]) & (
    candidate_times <= PARAMETERS[labeled_stop - 1]
)
