...
# DOWNSAMPLE_SPACING bounds the detection resolution, which has to stay below
# the cube side length, 1; `report` prints the resolution actually achieved.
# Detection points are spaced by distance rather than time, so MAX_LENGTH, a
