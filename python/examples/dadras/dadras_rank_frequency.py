...
Longer windows capture more independent cycling motions of the Dadras
attractor, shifting the distribution toward higher ranks as the length grows.
Windows are swept in detection samples, and each length is presented at the
median time its windows span.
"""
